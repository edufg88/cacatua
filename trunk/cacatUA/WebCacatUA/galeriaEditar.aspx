<%@ Page Language="C#" MasterPageFile="~/PaginaMaestraUsuario.Master" AutoEventWireup="true" CodeBehind="galeriaEditar.aspx.cs" Inherits="WebCacatUA.Formulario_web14" Title="Página sin título" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_contenidoUsuario" runat="server">
    ...
    <asp:Table ID="Table1" runat="server" Width="100%">
       ...
       <asp:TableRow>
        ...
        <asp:TableRow>
            <asp:TableCell style="width:30%"><asp:Button ID="Button1" runat="server" Text="Guardar" onclick="Button1_Click"/></asp:TableCell>
        </asp:TableRow>
